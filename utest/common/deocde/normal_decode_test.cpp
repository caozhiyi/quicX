...
TEST(normal_decode_utest, EncodeVarint32_1) {
    uint32_t value = 1 << 5;
    char buf[5];
    ...
    uint32_t value2 = 0;
    char* ret = quicx::DecodeVarint<uint32_t>(buf, buf+5, value2);
    EXPECT_EQ(ret, ptr);
    EXPECT_EQ(value, value2);
}

TEST(normal_decode_utest, EncodeVarint32_2) {
    uint32_t value = 1 << 13;
    char buf[5];
    char* ptr = quicx::EncodeVarint<uint32_t>(buf, value);
    EXPECT_EQ(ptr - buf, 2);
...
TEST(normal_decode_utest, EncodeVarint32_3) {
    uint32_t value = 1 << 20;
    char buf[5];
    char* ptr = quicx::EncodeVarint<uint32_t>(buf, value);
    EXPECT_EQ(ptr - buf, 3);
...
TEST(normal_decode_utest, EncodeVarint32_4) {
    uint32_t value = 1 << 27;
    char buf[5];
    char* ptr = quicx::EncodeVarint<uint32_t>(buf, value);
    EXPECT_EQ(ptr - buf, 4);
...
TEST(normal_decode_utest, EncodeVarint64_5) {
    ...
    uint64_t value2 = 0;
    char* ret = quicx::DecodeVarint<uint64_t>(buf, buf+9, value2);
    EXPECT_EQ(ret, ptr);
    EXPECT_EQ(value, value2);
}

TEST(normal_decode_utest, EncodeVarint64_6) {
...
TEST(normal_decode_utest, EncodeVarint64_7) {
...
TEST(normal_decode_utest, EncodeVarint64_8) {
...
TEST(normal_decode_utest, EncodeVarint8_9) {
    ...
    uint8_t value2 = 0;
    char* ret = quicx::DecodeVarint<uint8_t>(buf, buf+3, value2);
    EXPECT_EQ(ret, ptr);
    EXPECT_EQ(value, value2);
}
