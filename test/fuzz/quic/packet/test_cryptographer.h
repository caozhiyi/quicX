...
class PacketTest: public quicx::common::Singleton<PacketTest> {
public:
    PacketTest() {
        ...
        if (cli_cryptographer_->InstallInitSecret(dcid, quicx::quic::kMaxCidLength, quicx::quic::kInitialSalt.data(),
                quicx::quic::kInitialSalt.size(), false) != quicx::quic::ICryptographer::Result::kOk) {
            abort();
        }

        ser_cryptographer_ = quicx::quic::MakeCryptographer(quicx::quic::kCipherIdAes128GcmSha256);
        if (ser_cryptographer_->InstallInitSecret(dcid, quicx::quic::kMaxCidLength, quicx::quic::kInitialSalt.data(),
                quicx::quic::kInitialSalt.size(), true) != quicx::quic::ICryptographer::Result::kOk) {
            abort();
        }
    }
    ~PacketTest() {}
