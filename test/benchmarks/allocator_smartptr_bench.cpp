...
// allocatorWrap, plus a std::make_shared baseline. The goal is to quantify the
// effect of the recent if_allocator.h refactor:
...
//   - stay well below PoolAllocator's 256B cutoff even after ~40B of control-block
