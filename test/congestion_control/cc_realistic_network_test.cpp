...
TEST(RealisticNetworkTest, AlgorithmComparison_Broadband) {
    ...
    printf("-----------|------------|------------|------------|------------\n");
    printf("%-10s | %7.2f Mbps | %7.2f KB | %8.2f%% | %7.2f ms\n", "Reno", reno_metrics.throughput_mbps,
        reno_metrics.max_cwnd_bytes / 1024.0, reno_metrics.packet_loss_rate * 100, reno_metrics.avg_rtt_ms);
    printf("%-10s | %7.2f Mbps | %7.2f KB | %8.2f%% | %7.2f ms\n", "CUBIC", cubic_metrics.throughput_mbps,
        cubic_metrics.max_cwnd_bytes / 1024.0, cubic_metrics.packet_loss_rate * 100, cubic_metrics.avg_rtt_ms);
    printf("%-10s | %7.2f Mbps | %7.2f KB | %8.2f%% | %7.2f ms\n", "BBRv1", bbr_v1_metrics.throughput_mbps,
        bbr_v1_metrics.max_cwnd_bytes / 1024.0, bbr_v1_metrics.packet_loss_rate * 100, bbr_v1_metrics.avg_rtt_ms);
    printf("%-10s | %7.2f Mbps | %7.2f KB | %8.2f%% | %7.2f ms\n", "BBRv2", bbr_v2_metrics.throughput_mbps,
        bbr_v2_metrics.max_cwnd_bytes / 1024.0, bbr_v2_metrics.packet_loss_rate * 100, bbr_v2_metrics.avg_rtt_ms);
