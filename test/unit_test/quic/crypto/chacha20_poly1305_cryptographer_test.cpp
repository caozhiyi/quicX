...
TEST(ChaCha20Poly1305CryptographerTest, DecryptPacketInit) {
    std::shared_ptr<ChaCha20Poly1305Cryptographer> server_cryptographer =
        std::make_shared<ChaCha20Poly1305Cryptographer>();
    ...
    std::shared_ptr<ChaCha20Poly1305Cryptographer> client_cryptographer =
        std::make_shared<ChaCha20Poly1305Cryptographer>();
