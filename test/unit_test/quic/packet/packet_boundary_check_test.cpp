...
TEST(PacketBoundaryTest, init_packet_token_length_overflow) {
...
TEST(PacketBoundaryTest, init_packet_length_overflow) {
    uint8_t raw[64] = {0};
    uint8_t pos = 0;
...
TEST(PacketBoundaryTest, handshake_packet_length_overflow) {
    uint8_t raw[64] = {0};
    uint8_t pos = 0;
...
TEST(PacketBoundaryTest, rtt0_packet_length_overflow) {
    uint8_t raw[64] = {0};
    uint8_t pos = 0;
