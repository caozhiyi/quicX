...
TEST(NormalDecodeTest, EncodeFixed_1) {
    uint32_t value = 1 << 5;
    uint8_t buf[5];
...
TEST(NormalDecodeTest, EncodeFixed_2) {
    uint32_t value = 1 << 13;
    uint8_t buf[5];
    uint8_t* ptr = FixedEncodeUint32(buf, buf + sizeof(buf), value);
    EXPECT_EQ(ptr - buf, sizeof(uint32_t));
...
TEST(NormalDecodeTest, EncodeFixed_3) {
    uint32_t value = 1 << 20;
    uint8_t buf[5];
    uint8_t* ptr = FixedEncodeUint32(buf, buf + sizeof(buf), value);
    EXPECT_EQ(ptr - buf, sizeof(uint32_t));
...
TEST(NormalDecodeTest, EncodeFixed_4) {
    uint32_t value = 1 << 27;
    uint8_t buf[5];
    uint8_t* ptr = FixedEncodeUint32(buf, buf + sizeof(buf), value);
    EXPECT_EQ(ptr - buf, sizeof(uint32_t));
...
TEST(NormalDecodeTest, EncodeFixed_9) {
...
TEST(NormalDecodeTest, EncodeFixed_10) {
    uint16_t value = 0x04;
    uint8_t buf[3];
