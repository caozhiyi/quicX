...
ClientConnection::ClientConnection(std::shared_ptr<TLSCtx> ctx, std::shared_ptr<ISender> sender,
    ...
    BaseConnection(StreamIDGenerator::StreamStarter::kClient, false, sender, loop, active_connection_cb,
