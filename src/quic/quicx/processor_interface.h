...
public:
    ...
    virtual bool HandlePacket(std::shared_ptr<UdpPacketIn> udp_packet, std::shared_ptr<ITimer> timer) = 0;
    virtual bool HandlePackets(const std::vector<std::shared_ptr<UdpPacketIn>>& udp_packets, std::shared_ptr<ITimer> timer) = 0;
