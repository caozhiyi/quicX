...
bool StreamDataBlockedFrame::Encode(std::shared_ptr<IBufferWriteOnly> buffer) {
...
bool StreamDataBlockedFrame::Decode(std::shared_ptr<IBufferReadOnly> buffer, bool with_type) {
