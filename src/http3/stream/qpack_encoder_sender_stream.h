 ...
 * It is responsible for sending the SET_DYNAMIC_TABLE_CAPACITY, INSERT_WITH_NAME_REFERENCE,
 * INSERT_WITHOUT_NAME_REFERENCE, and DUPLICATE frames.
 */
class QpackEncoderSenderStream: public ISendStream {
public:
...
#endif  // HTTP3_STREAM_QPACK_ENCODER_SENDER_STREAM
