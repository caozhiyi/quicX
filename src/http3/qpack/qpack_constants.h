...
// RFC 9204 Section 4.5.4: Literal Header Field With Name Reference
// Format: 01NT where T=1 for static, T=0 for dynamic, N is Never-Indexed bit
// Name Index uses 4-bit prefix

// Literal Header Field With Name Reference — Static (0101xxxx, N=0, T=1)
constexpr uint8_t kLiteralNameRefStatic = 0x50;
constexpr uint8_t kLiteralNameRefStaticMask = 0xF0;
constexpr uint8_t kLiteralNameRefStaticPrefix = 4;

// Literal Header Field With Name Reference — Dynamic (0100xxxx, N=0, T=0)
constexpr uint8_t kLiteralNameRefDynamic = 0x40;
constexpr uint8_t kLiteralNameRefDynamicMask = 0xF0;
constexpr uint8_t kLiteralNameRefDynamicPrefix = 4;
