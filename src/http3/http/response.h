...
public:
    ...
    virtual void AppendPush(std::shared_ptr<IResponse> response) override;
    virtual std::vector<std::shared_ptr<IResponse>>& GetPushResponses() override { return push_responses_; }
