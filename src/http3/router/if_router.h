...
public:
    ...
    // add route context
    virtual bool AddRoute(HttpMethod mothed, const std::string& path, const http_handler& handler) = 0;

    // router match
    virtual MatchResult Match(HttpMethod mothed, const std::string& path) = 0;
};
