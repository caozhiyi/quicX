...
public:
     ...
     */
    virtual bool AddRoute(const std::string& path, int path_offset, const RouteConfig& config) = 0;
     ...
     */
    virtual bool Match(
        const std::string& path, int path_offset, const std::string& cur_section, MatchResult& result) = 0;
};
