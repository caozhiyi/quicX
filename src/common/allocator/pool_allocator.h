#ifndef COMMON_ALLOCATOR_POOL_ALLOCATOR
#define COMMON_ALLOCATOR_POOL_ALLOCATOR
 ...
 *                                                 NormalAllocator (plain malloc).
 *
 * Lifetime:
 *   - Chunks are only released in ~PoolAllocator(). The pool is monotonically
